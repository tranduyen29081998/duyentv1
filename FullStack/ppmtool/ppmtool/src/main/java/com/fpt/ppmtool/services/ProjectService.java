...
import com.fpt.ppmtool.exceptions.ProjectIdException;
    ...
    public Project saveOrUpdateProject(Project project, String username){
        ...
        if(project.getId() != null){
            ...
            if(existingProject !=null &&(!existingProject.getProjectLeader().equals(username))){
                throw new ProjectNotFoundExceptionInput("Project not found in your account");
            }else if(existingProject == null){
                throw new ProjectNotFoundExceptionInput("Project with ID: '"+project.getProjectIdentifier()+"' cannot be updated because it doesn't exist");
            }
        }
